...
import { FormReparar, FormVerificado, FormVisualizar } from "../inyeccion/reparaciones/componentes"
...
const InyeccionRoutes = () => {
  return(
    <Routes>
        ...
        <Route path = "/moldes/create" element = {< FormCreateMatriceria/>}/>
        <Route path = "/maquinas/create" element = {< FormCreateInyectoras/>}/>
